...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20211220.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20211220
cd %{_builddir}/CPAN-Perl-Releases-5.20211220
...
cp %{_builddir}/CPAN-Perl-Releases-5.20211220/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/4c0172270b65bb7be6e6a1c76ae0a3802c704892
if test -f Makefile.PL; then
