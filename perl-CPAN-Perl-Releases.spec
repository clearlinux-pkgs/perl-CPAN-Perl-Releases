...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20210120.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20210120
cd %{_builddir}/CPAN-Perl-Releases-5.20210120
...
cp %{_builddir}/CPAN-Perl-Releases-5.20210120/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/3e0a5270003ca3405316779a1d74fca446fe13d2
if test -f Makefile.PL; then
