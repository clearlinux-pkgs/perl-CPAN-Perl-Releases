...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20210320.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20210320
cd %{_builddir}/CPAN-Perl-Releases-5.20210320
...
cp %{_builddir}/CPAN-Perl-Releases-5.20210320/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/3e0a5270003ca3405316779a1d74fca446fe13d2
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.32.1/CPAN/Perl/Releases.pm
