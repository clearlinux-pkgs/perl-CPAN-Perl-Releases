...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20250422.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20250422
cd %{_builddir}/CPAN-Perl-Releases-5.20250422
pushd ..
cp -a CPAN-Perl-Releases-5.20250422 buildavx2
popd
...
cp %{_builddir}/CPAN-Perl-Releases-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/8853d40572863df005e877ab50bc28fd1571e39d || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-CPAN-Perl-Releases/8853d40572863df005e877ab50bc28fd1571e39d
