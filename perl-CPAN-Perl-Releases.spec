...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20240829.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20240829
cd %{_builddir}/CPAN-Perl-Releases-5.20240829
pushd ..
cp -a CPAN-Perl-Releases-5.20240829 buildavx2
popd
...
cp %{_builddir}/CPAN-Perl-Releases-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/03baf75901e0da41382b33c31a7a3c80601fca0c || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-CPAN-Perl-Releases/03baf75901e0da41382b33c31a7a3c80601fca0c
