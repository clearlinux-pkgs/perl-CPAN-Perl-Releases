...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20210620.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20210620
cd %{_builddir}/CPAN-Perl-Releases-5.20210620
...
cp %{_builddir}/CPAN-Perl-Releases-5.20210620/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/3e0a5270003ca3405316779a1d74fca446fe13d2
if test -f Makefile.PL; then
