...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20220720.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20220720
cd %{_builddir}/CPAN-Perl-Releases-5.20220720
...
cp %{_builddir}/CPAN-Perl-Releases-5.20220720/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/e5f46769b9ca337e4bc76110121f04f646a65264
if test -f Makefile.PL; then
