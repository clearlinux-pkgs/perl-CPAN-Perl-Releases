...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20240120.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20240120
cd %{_builddir}/CPAN-Perl-Releases-5.20240120
pushd ..
cp -a CPAN-Perl-Releases-5.20240120 buildavx2
popd
