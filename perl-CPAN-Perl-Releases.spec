...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20200530.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20200530
cd %{_builddir}/CPAN-Perl-Releases-5.20200530
...
cp %{_builddir}/CPAN-Perl-Releases-5.20200530/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/649d1476f8b509d93226add820e9e6e6a6ef6e01
if test -f Makefile.PL; then
