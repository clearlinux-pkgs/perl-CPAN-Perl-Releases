...
Source0  : https://cpan.metacpan.org/authors/id/B/BI/BINGOS/CPAN-Perl-Releases-5.20191220.tar.gz
...
%prep
%setup -q -n CPAN-Perl-Releases-5.20191220
cd %{_builddir}/CPAN-Perl-Releases-5.20191220
...
cp %{_builddir}/CPAN-Perl-Releases-5.20191220/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/b131d9964b46d69934910d731ce6154e199383ca
if test -f Makefile.PL; then
