...
%prep
%setup -q -n CPAN-Perl-Releases-5.20200314
cd %{_builddir}/CPAN-Perl-Releases-5.20200314
...
cp %{_builddir}/CPAN-Perl-Releases-5.20200314/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Perl-Releases/649d1476f8b509d93226add820e9e6e6a6ef6e01
if test -f Makefile.PL; then
